...
img1 = cv.imread('./out/calib/IMG_0682.JPG', cv.IMREAD_GRAYSCALE)  # queryimage # left image
img2 = cv.imread('./out/calib/IMG_0677.JPG', cv.IMREAD_GRAYSCALE)  # trainimage # right image
sift = cv.SIFT_create()
